...
const UpdateTrack = ({ classes, track }) => {
  ...
  const handleAudioChange = event => {
    ...
    const fileSizeLimit = 60000000; // 60mb mp3 file
  ...
  const handleAudioUpload = async () => {
    ...
    data.append('upload_preset', 'podcast-app');
    data.append('cloud_name', 'cryptopotluck');
  ...
  return isCurrentUser && (
    ...
    >
      ...
      <form onSubmit={event => handleSubmit(event, updateTrack)}>
        ...
        <DialogContent>
          <DialogContentText>
            Update the Title, Description & Podcast.mp3 File (under 60mb)
          </DialogContentText>
